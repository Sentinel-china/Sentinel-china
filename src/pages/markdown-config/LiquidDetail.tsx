/**
 * Liquid Level Sensor产品案例详情页面组件
 * 动态加载液位传感器产品案例markdown文档并应用统一样式
 */
...
// 导入液位传感器产品案例markdown文件
import liquid01Content from '../articles/markdown-cases/liquid01.md?raw'
import liquid02Content from '../articles/markdown-cases/liquid02.md?raw'
import liquid03Content from '../articles/markdown-cases/liquid03.md?raw'
import liquid04Content from '../articles/markdown-cases/liquid04.md?raw'
import liquid05Content from '../articles/markdown-cases/liquid05.md?raw'
import liquid06Content from '../articles/markdown-cases/liquid06.md?raw'
...
const markdownContentMap = {
  'liquid01': liquid01Content,
  'liquid02': liquid02Content,
  'liquid03': liquid03Content,
  'liquid04': liquid04Content,
  'liquid05': liquid05Content,
  'liquid06': liquid06Content
}
...
export default function LiquidDetail() {
  ...
  useEffect(() => {
    if (productId && liquidConfig[productId as keyof typeof liquidConfig]) {
      setProduct(liquidConfig[productId as keyof typeof liquidConfig])
  ...
  const loadMarkdownContent = async (id: string) => {
    try {
      ...
      console.log('尝试加载液位传感器产品markdown文件:', id)
      ...
      if (content) {
        ...
        // 如果文件不存在，显示默认内容
        const defaultContent = `# ${liquidConfig[id as keyof typeof liquidConfig]?.title || '液位传感器产品详情'}

## 概述

该液位传感器产品的详细文档正在准备中，请稍后再来查看。
      ...
      <div className="min-h-screen pt-16 bg-gray-900">
        <div className="max-w-4xl mx-auto px-4 py-16">
          <div className="text-center">
            ...
            <Link 
              to="/products/sensor/liquid-level-sensor" 
      ...
      <section className="px-4 sm:px-6 lg:px-8 py-8">
        <div className="max-w-7xl mx-auto">
          ...
          >
            ...
            Back to Liquid Level Sensor Products
          </Link>
