 ...
 */
import { ArrowLeft, Cloud, Server, Shield, Zap, BarChart3, Users, Check, Phone, Mail, ArrowRight, Download, Play, Monitor, Database, Cpu } from 'lucide-react'
        ...
        <div className="max-w-7xl mx-auto">
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            <div className="relative">
              <img
                src="https://pub-cdn.sider.ai/u/U0D4XHG6Z0/web-coder/68902bc70cd2d7c5a266e9f7/resource/6b00c35d-159c-4586-8057-4086fa4481ee.jpg"
                alt="云计算服务"
